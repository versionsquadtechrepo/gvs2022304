...
const Header: React.FC = () => {
  ...
  const headerCss = router.pathname.indexOf('ancient') > 0 ? 'w-full h-28 sm:h-20 lg:h-24 absolute lg:relative z-20' : 'w-full h-28 sm:h-20 lg:h-24 relative lg: z-20'
  ...
  return (
    <>
      ...
      <header id="siteHeader" ref={siteHeaderRef} className={headerCss}>
        ...
        <div className={'innerSticky text-gray-700 body-font top-16 absolute lg:hidden ' + (router.pathname.indexOf('ancient') > 0 ? '' : 'bg-white') + ' w-full h-16 sm:h-20  px-4 md:px-8 lg:px-6 transition duration-200 ease-in-out '}>
          <div className="relative mb-6">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <svg fill="none" className="w-5 h-5 text-gray-500 dark:text-gray-400" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
              <svg fill="#CB2027" className="w-5 h-5 text-red-500 dark:text-gray-400" stroke="#CB2027" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
