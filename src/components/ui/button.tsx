...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const rootClassName = cn(
    'rounded-full text-[13px] md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold font-body text-center justify-center border-0 border-transparent placeholder-white focus-visible:outline-none focus:outline-none',
    {
      'rounded-md ': !disableBorderRadius,
      'bg-giRed text-white px-5 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 hover:text-white hover:bg-gray-600 hover:shadow-cart':
        variant === 'flat',
